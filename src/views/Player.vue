<template>
  <div class="container-fluid">
    <div class="col">
      ...
      <table class="table">
        ...
        <tbody>
        <tr v-for="player in players.filter(p => p.student)" :key="player.id">
          ...
          <td>
            <button type="button" class="btn" aria-label="Edit" @click='editPlayer(player.id)' data-bs-toggle='offcanvas' data-bs-target='#players-create-offcanvas'
  ...
  <player-create-form @playerCreated="playerCreated" @playerUpdated="playerUpdated" @formCleared="formCleared" :player-id="editedPlayerId" ></player-create-form>
</template>
